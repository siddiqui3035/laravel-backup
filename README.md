...
## Add mailtrap credintidals on .env for get back notification on mail;
```php
MAIL_MAILER=smtp
...
## Now go to config/backup.php and update your file by below code;
```php
<?php
